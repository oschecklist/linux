...
sudo apt-get update
sudo apt-get install keepass2 git ncdu htop screen nano wget curl tree transmission gnome-system-monitor rar unrar zip unzip bsdgames dconf-editor kid3 elementary-tweaks love -y
